            ...
            <div className="flex items-start gap-2">
              ...
              <div className="text-xs">
                ...
                <p className="text-muted-foreground">
                  ...
                  <span className="text-primary">Delete</span> on messages, or
                  the <span className="text-primary">attachment</span> button to
                  see cute "not ready" messages!
                </p>
              </div>
            </div>
          </motion.div>
              ...
              <div className="space-y-1">
                {filteredConversations.map((c, index) => {
                  ...
                  return (
                    ...
                    >
                      {c.user.avatarUrl ? (
                        <Avatar name={c.user.avatarUrl} size="sm" />
                      ) : (
